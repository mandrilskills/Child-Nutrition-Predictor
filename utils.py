...
def generate_pdf_report(patient_data, bmi, ml_prediction, explainer_text, unicef_text):
    ...
    pdf.cell(200, 10, txt="Socio-Economic & Geo-Cultural Nutrition Report", ln=True, align='C')
    ...
    pdf.set_font("Arial", style="B", size=12)
    pdf.cell(200, 10, txt="3. AI Clinical Analysis (Neuro-Symbolic Explainer):", ln=True)
    pdf.set_font("Arial", size=11)
    ...
    pdf.set_font("Arial", style="B", size=12)
    pdf.cell(200, 10, txt="4. Cost-Constrained Regional Intervention Plan:", ln=True)
    pdf.set_font("Arial", size=11)
